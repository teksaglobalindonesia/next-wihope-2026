  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        standardSecondary:  'bg-neutral-white text-brand-primary border border-brand-primary transition duration-200 hover:bg-neutral-silver focus:bg-neutral-l-grey focus:border-2 focus:border-neutral-l-grey active:bg-neutral-silver disabled:bg-neutral-silver disabled:text-neutral-grey-blue',
