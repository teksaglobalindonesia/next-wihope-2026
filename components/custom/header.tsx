...
export default function Header() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex h-[84px] w-full justify-between bg-[#F5F7FA] px-8">
      ...
      <div className="mt-7 ml-6 flex h-[24px] w-[588px] flex-row items-center gap-8 text-gray-900 font-inter text-sm">
      ...
      <div className="mr-6 flex flex-row items-center gap-2 px-[20px] py-[10px]">
        {isLoggedin ? (
          <>
            ...
            <Link href={'/'}><CustButton size={'medium'} variant={'secondary'} className="font-inter text-sm font-medium"onClick={handleLogout}>Logout</CustButton></Link>
          </>
        ) : (
          <>
